...
##activate disc
execute as @a[predicate=dot:dot/deactivatedisc,tag=holdingactivediscmainhand,tag=!blocking] run function dot:helddisc/deactivate
...
execute as @a[predicate=!dot:dot/holdingactivedisc/holdingactivediscmainhand] run tag @s remove holdingactivediscmainhand
