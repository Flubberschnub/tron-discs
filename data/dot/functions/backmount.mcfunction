...
execute if score tempDiscCount Constant matches 1.. as @s[tag=!discthrown,predicate=!dot:dot/is_wearing_head_item,predicate=!dot:dot/holdingdisc] run function dot:backmount/replaceitem
