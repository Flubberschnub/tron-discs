...
replaceitem entity @s[scores={circuitcolor=3}] armor.head minecraft:carrot_on_a_stick{display:{Name:'{"text":"[Back-Mounted Disc]","color":"dark_gray","italic":false}'},headdisc:1,CustomModelData:3993}
