...
execute if score @s circuitcolor matches 3 run replaceitem entity @s weapon.offhand minecraft:carrot_on_a_stick{display:{Name:'{"text":"Identity Disc","color":"gray","bold":true,"italic":false}',Lore:['{"text":"A disc that stores","color":"dark_gray"}','{"text":"the memories of a program.","color":"dark_gray"}']},HideFlags:63,Unbreakable:1b,CustomModelData:3991,disc:1,activated:1,color:3,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:5,Operation:0,UUID:[I;-832210119,-259766934,-1219046730,-1143504729]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:10,Operation:0,UUID:[I;1667580869,-344963044,-1435523797,-1616899539]}]} 1
