...
execute if score @s circuitcolor matches 3 run summon armor_stand ~ ~1 ~ {CustomNameVisible:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Silent:1b,PersistenceRequired:1b,Tags:["throwndisc","justthrown"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:3991}}],CustomName:'{"text":"throwndisc"}'}
